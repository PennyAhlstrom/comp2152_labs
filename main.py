...
while not input_valid and i in range(5):
    ...
    try:
        ...
        print("Invalid input. Player needs to enter an integer number for Combat Strength.")
        i += 1
        continue # Goes back to input for combat strength again

    # Note: combat strength was safely converted to integer
    # Validate input: Check if the string inputted is between 1-6
...
while not m_input_valid and i in range(5):
    ...
    # Note: monster combat strength was safely converted to integer
    # Validate input: Check if the string inputted is between 1-6
